...
pub const struct_Vector2 = extern struct {
    ...
    pub const DrawTriangleLinesEx = __root.DrawTriangleLinesEx;
    ...
    pub const DrawCircleSectorLinesEx = __root.DrawCircleSectorLinesEx;
    ...
    pub const DrawEllipseLinesEx = __root.DrawEllipseLinesEx;
    pub const DrawRing = __root.DrawRing;
    pub const DrawRingLines = __root.DrawRingLines;
    pub const DrawRingLinesEx = __root.DrawRingLinesEx;
...
pub const __nonnull = @compileError("unable to translate C expr: unexpected token '_Nonnull'"); // <builtin>:59:9
pub const __null_unspecified = @compileError("unable to translate C expr: unexpected token '_Null_unspecified'"); // <builtin>:60:9
pub const __nullable = @compileError("unable to translate C expr: unexpected token '_Nullable'"); // <builtin>:61:9
...
pub const __UINTMAX_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `UL`"); // <builtin>:129:9
...
pub const __INT64_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `LL`"); // <builtin>:155:9
...
pub const __UINT32_FMTX__ = "X";
pub const __UINT32_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `U`"); // <builtin>:180:9
...
pub const __UINT64_FMTX__ = "llX";
pub const __UINT64_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `ULL`"); // <builtin>:189:9
...
pub const RL_MALLOC = @compileError("unable to translate macro: undefined identifier `malloc`"); // /Users/petkovl/work/zig_tasks/test_raylib/raylib/src/raylib.h:132:13
pub const RL_CALLOC = @compileError("unable to translate macro: undefined identifier `calloc`"); // /Users/petkovl/work/zig_tasks/test_raylib/raylib/src/raylib.h:135:13
pub const RL_REALLOC = @compileError("unable to translate macro: undefined identifier `realloc`"); // /Users/petkovl/work/zig_tasks/test_raylib/raylib/src/raylib.h:138:13
pub const RL_FREE = @compileError("unable to translate macro: undefined identifier `free`"); // /Users/petkovl/work/zig_tasks/test_raylib/raylib/src/raylib.h:141:13
